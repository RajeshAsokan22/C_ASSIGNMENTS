...
int circular_right(int, int);   /* declaring functions with parameter */
int print_bits(int);
...
int main()
{
    ...
    ret = circular_right(num, n);  /* circular_right function will be called and return value will be stored in a variable "ret" */
